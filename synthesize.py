...
last_checkpoint_file_name = '../logdir_disgust2/%s-text2mel/step-001K.pth' % args.dataset
...
for i in range(len(SENTENCES)):
    ...
    save_to_png('samples/samples_bea_disgust_1k/%d-att.png' % (i + 1), A[0, :, :])
    save_to_png('samples/samples_bea_disgust_1k/%d-mel.png' % (i + 1), Y[0, :, :])
    save_to_png('samples/samples_bea_disgust_1k/%d-mag.png' % (i + 1), Z[0, :, :])
    save_to_wav(Z[0, :, :].T, 'samples/samples_bea_disgust_1k/%d-wav.wav' % (i + 1))
